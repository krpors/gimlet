...
public class NamedParameterPreparedStatement extends DelegatingPreparedStatement {
    ...
    public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(
        ...
        return new NamedParameterPreparedStatement(
                conn.prepareStatement(parseResult.getSql()), parseResult.getOrderedParameters());
    }

    public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(
            Connection conn, String sql, int autoGeneratedKeys) throws SQLException {
        ParseResult parseResult = parse(sql);
    ...
    public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(
            Connection conn, String sql, int[] columnIndexes) throws SQLException {
        ParseResult parseResult = parse(sql);
    ...
    public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(
            Connection conn, String sql, String[] columnNames) throws SQLException {
        ParseResult parseResult = parse(sql);
    ...
    public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(
            Connection conn, String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        ParseResult parseResult = parse(sql);
    ...
    public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(
            Connection conn, String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ParseResult parseResult = parse(sql);
        return new NamedParameterPreparedStatement(
                conn.prepareStatement(parseResult.getSql(), resultSetType, resultSetConcurrency, resultSetHoldability),
                parseResult.getOrderedParameters());
    }
